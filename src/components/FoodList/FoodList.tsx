    ...
    <>
      <div className="flex flex-col">
        ...
        <div className=" flex  justify-between items-baseline w-full m-5 px-2  ">
          <div className=" flex  items-start border-b-2 md:w-1/4 border p-1">
            <input
              className=" focus:outline-none  w-full  text-xs md:text-sm lg:text-lg "
              type="text"
